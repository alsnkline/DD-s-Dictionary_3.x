...
#define ApptimizeInt(_name, _value)     _ApptimizeVariableDeclaration(_name, i) _ApptimizeVariableInitializer(_name, i, ,default_ = _Generic(_value, \
    int:           @(_value), \
    unsigned int:  @(_value), \
    long:          @(_value), \
    unsigned long: @(_value)))
#define ApptimizeDouble(_name, _value)  _ApptimizeVariableDeclaration(_name, d) _ApptimizeVariableInitializer(_name, d, ,default_ = _Generic(_value, \
    float:  @(_value), \
    double: @(_value)))
#define ApptimizeBoolean(_name, _value) _ApptimizeVariableDeclaration(_name, b) _ApptimizeVariableInitializer(_name, b, , default_ = _Generic(_value, BOOL: @(_value)))

...
struct _apptimize_variable_descriptor {
    ...
    __strong id *p; char *n; char *t; __strong id *d;
};
...
#define _ApptimizeVariableDeclaration(_name, _type) __attribute__((unused)) NSObject< _ApptimizeVariableProtocol_ ## _type > * _name;
#define _ApptimizeVariableInitializer(_name, _type, _subtype, ...) \
    static void __attribute__((constructor)) _atz_var_init ## _name () { \
        ...
        __attribute__((used,unused,section(_ApptimizeVariableSegment "," _ApptimizeVariableConstSection))) static char name_[] = #_name; \
        __attribute__((used,unused,section(_ApptimizeVariableSegment "," _ApptimizeVariableConstSection))) static char type_[] = "" #_type #_subtype ""; \
        static struct _apptimize_variable_descriptor __attribute__((used,unused,section(_ApptimizeVariableSegment "," _ApptimizeVariableSection))) desc_ = { &(_name), (char*)name_, (char*)type_, &default_ }; \
        __VA_ARGS__; \
    }
#define _ApptimizeEnsuredObjectTypeVariable(_name, _ensuredType, _type, _subtype, ...) _ApptimizeVariableDeclaration(_name, _type) _ApptimizeVariableInitializer(_name, _type, _subtype, default_ = _Generic((__VA_ARGS__), _ensuredType: (__VA_ARGS__), void*: nil))

...
void
DoubleMetaphone(const char *str, char **primarycode, char **secondarycode)
{
    int        length;
    metastring *original;
    metastring *primary;
    ...
    /* main loop */
    while ((primary->length < 8) || (secondary->length < 8))
      {
	  if (current >= length)
	      break;
...
//        case '\u0199': //cidilla for European languages - my attempted fix.
//	    case 'Ç':  // original
//		MetaphAdd(primary, "S");
//		MetaphAdd(secondary, "S");
//		current += 1;
...
//	    case '\u0165': //N tilde for European languages
//	    case 'Ñ':
//		current += 1;
//		MetaphAdd(primary, "N");
//		MetaphAdd(secondary, "N");
//		break;
    ...
    *primarycode = primary->str;
    *secondarycode = secondary->str;

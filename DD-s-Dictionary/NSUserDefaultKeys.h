...
#define VOICE_HINT_AVAILABLE @"DDPrototype.VoiceHintsAvailable"  //appington used this to provide control and voice groups (def false Jan 2015) changable
#define NOT_USE_VOICE_HINTS @"DDPrototype.NotUseVoiceHints"     //user control to turn off voice hints (defaulted off from Jan 2015)
